...
If you write software for a living, then you likely spend your days interacting with people who argue with such monomaniacal vigor about optimal keyboard shortcuts that you’d think they were defending their PhD theses. On top of that, if you are a woman, you also probably spend lots of time convincing people you really do know how to code. Combine these two and the fact that programming really is hard and it’s no wonder so many of us feel like imposters. I was familiar with this feeling, but I didn’t know the name for it until 2013, when Facebook COO Sheryl Sandberg published her famous book on the topic, Lean In. That was around the time I started to learn to code myself, as a college sophomore, and began to ask myself: “Is the problem that I’m an imposter, or that I have imposter syndrome?”



It would be hard for me to name a single female software engineer who doesn’t ask themselves that question on the regular (surely many men do this, too--though I know many more who don’t). But this is where things get complicated, because when you know you may be suffering from imposter syndrome, you feel the need to counteract it. You come to the conclusion that this queasy feeling in your gut is wrong--that the insecure part of you is delusional--and that you should no longer let your gut instincts guide your actions. Instead, you enable manual override, behaving in the way you think a confident person would. You start conversations by listing your credentials; you find every opportunity to name drop your alma mater; you post your every accolade on social media. (I’m guilty of all of these things.) It feels like bragging, but it’s hard to tell, because isn’t that what somebody with imposter syndrome would think?



I empathize with folks who do this kind of thing, especially because they’re often the ones facing the most bias. But my take is that this sort of self-promotion rings hollow. Meanwhile, in the midst of our credential-dropping, we often fail to show confidence in situations that actually do sway people’s views of us. For example, I have a tendency to give an opinion and immediately caveat it with, “but I have no idea what I’m talking about,” and, “but you should definitely Google that.” And this type of back-talk totally does make me seem less competent.
...
So what’s the solution? For me, the answer has been to focus on acquiring “true confidence”--the type that my brain and my gut both agree I should have. I’ve done this neither by repeating to myself the daily affirmation “You are great at Python developer,” nor by going back to school for my PhD. But here’s what I’ve done that has worked.
...
You don’t need a college degree in Computer Science to be a successful coder, but I will say that taking the traditional university route gave me an irreplaceable experience: seeing first hand the differences in the way I think about myself, versus the way my classmates--who would eventually become my coworkers--thought and talked about themselves.



Switching into Computer Science as a sophomore, I was already somehow “behind.” Lots of my classmates had been coding since they were in utero. The field is vast, and I had no idea what people were talking about most of the time: Arch Linux? Lambda functions? emacs? Neural networks? And it wasn’t just the lingo that intimidated me. It was also that my classmates had such strong opinions! Why was it so important that I give up my Macbook Pro for a computer with an operating system that couldn’t hibernate or play audio? Why did I have to write code in a text editor with no graphical user interface that was built in the 70s? I had no idea, but I was convinced it was what legit programmers did.
...
The plural of anecdote is not data, but the data do support this “confidence gap” across gender lines six ways to Sunday: in the lab, women predicted their scores on tests were significantly lower than men did, even when their performance was the same. In one study, women applied for promotions only when they thought they met 100 percent of job qualifications; men applied when they met only 60 percent. This phenomenon is one of the most repeatable results in psychology.
...
I’ve seen another common variant when my female coworkers are asked if they can complete a task. In one meeting, a project manager asked (the only other) female engineer on our team if she could build a feature.
